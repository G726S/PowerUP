...
-- Single global balance -- there's no user/auth model yet, so points earned
-- from quizzes are shared across whoever is using this instance.
CREATE TABLE IF NOT EXISTS points_balance (
    id INTEGER PRIMARY KEY CHECK (id = 1),
    total INTEGER NOT NULL DEFAULT 0
);
INSERT OR IGNORE INTO points_balance (id, total) VALUES (1, 0);
"""
